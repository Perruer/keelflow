...
const swaggerUiOptions = {
    ...
    definition: {
        ...
        info: {
            ...
            version: '1.0.0',
            description:
                'This module serves auto-generated swagger-ui generated API docs from the Keelflow express backend, based on a swagger.yml file. Swagger is available on: http://localhost:6655/api-docs',
            license: {
                name: 'Apache 2.0',
                url: 'https://github.com/Perruer/keelflow/blob/main/LICENSE.md'
            },
            contact: {
                name: 'Keelflow',
                url: 'https://github.com/Perruer/keelflow/issues'
            }
        },
        servers: [
            {
                url: 'http://localhost:3000/api/v1',
                description: 'Keelflow server'
            }
        ]
    },
